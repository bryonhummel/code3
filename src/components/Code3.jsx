...
function EditButton(props) {
    return( <button className='border border-white rounded-md py-1.5 text-gray-200 sm:hover:bg-gray-100 active:bg-gray-100' onClick={props.handleClick}>
...
function EmsButton(props) {
    return( <button className=' fill-red-600 sm:hover:fill-white active:fill-white flex items-center border border-red-600 rounded-md px-2 py-0.5 text-red-600 sm:hover:bg-red-500 sm:hover:text-white active:text-white active:bg-red-500 text-base' onClick={props.handleClick}>
...
function Timeline(props) {
    ...
    var entries = {
        "onSceneTs": props?.onSceneTs ? props.onSceneTs.replace(':',"") : 1000001,
        "sceneClearTs": props?.sceneClearTs ? props.sceneClearTs.replace(':',"") : 1000002,
    }
    if (props?.emsCalledTs) {
        entries["emsCalledTs"] = props?.emsCalledTs ? props.emsCalledTs.replace(':',"") : 1000003
        entries["emsArrivedTs"] = props?.emsArrivedTs ? props.emsArrivedTs.replace(':',"") : 1000004
    }
